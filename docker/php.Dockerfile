...
RUN apt-get update && \
    apt-get install -y git zip curl libcurl3-dev libxml2-dev libssl-dev zlib1g-dev libpng-dev libonig-dev libc-client-dev libkrb5-dev cron sudo libmemcached-dev libz-dev memcached libmemcached-tools
